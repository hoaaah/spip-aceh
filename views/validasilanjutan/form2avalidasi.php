...
foreach($respondens as $responden){
    $columns[] = [
        ...
        'value' => function($model) use($responden){
            $jawaban = \app\models\KuisionerAwalValidasi::findOne(['tahun' => $responden->tahun, 'responden_id' => $responden->id, 'pemda_id' => $responden->pemda_id, 'survai_awal_id' => $model->id]);
