...
<div class="responden-kuisioner-awal-form">
    ...
    <?php
        ...
        foreach($questions AS $question){ 
            ...
            if(\app\models\KuisionerLanjutan::findOne(['responden_id' => $responden_id, 'survai_lanjutan_id' => $question['id']]))
                $model->jawabanArray[$question['id']] = \app\models\KuisionerLanjutan::findOne(['responden_id' => $responden_id, 'survai_lanjutan_id' => $question['id']])['jawaban'];
